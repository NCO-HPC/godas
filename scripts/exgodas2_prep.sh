...
export EXECmkAsmPrf=${EXECmkAsmPrf:-$EXECgodas/godas_dw_mkAsmPrf}
export EXECmkAsmPrfs=${EXECmkAsmPrfs:-$EXECgodas/godas_dw_mkAsmPrfs}
export EXECmkAsmAlt=${EXECmkAsmAlt:-$EXECgodas/godas_dw_mkAsmAlt}
...
ln -sf $FIXgodas/godas_ann.temp fort.13
ln -sf tmpa.ext fort.61
