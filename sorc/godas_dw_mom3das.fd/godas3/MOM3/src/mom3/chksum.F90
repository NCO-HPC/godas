...
#if defined(SGICRAY) || defined(__alpha) || defined(sgi_generic)
...
!this works with IEEE words, where any bit sequence is a valid integer
  implicit none
  private
  character(len=256), private :: version='$Id: chksum.F90 100938 2019-06-17 17:50:05Z hyun-chul.lee@noaa.gov $'
...
#else
      print *, 'CHKSUM ERROR: requires CRI pointers.'
      chksum_r8_0d = 0
#endif
      return
